...
import com.example.quanly_hssv.adapter.adapterClasses;
...
public class ActivityClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarClass = findViewById(R.id.toolbarClass);

        setSupportActionBar(toolbarClass);
    ...
    private void addControls() {
        ImageButton ibtnAddClass = (ImageButton) findViewById(R.id.ibtnAddClass);
        ibtnAddClass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ActivityClass.this, ActicityAddClass.class);
                startActivity(intent);
            }
        });
        listView = findViewById(R.id.listviewClass);
        list = new ArrayList<>();
        adapter = new adapterClasses(this, list);
